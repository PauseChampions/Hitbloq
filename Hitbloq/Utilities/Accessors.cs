...
namespace Hitbloq.Utilities
{
	internal static class Accessors
	{
		...
		public static readonly FieldAccessor<LeaderboardTableCell, Image>.Accessor LeaderboardCellSeparatorAccessor = FieldAccessor<LeaderboardTableCell, Image>.GetAccessor("_separatorImage");
		public static readonly FieldAccessor<LevelSelectionFlowCoordinator.State, SelectLevelCategoryViewController.LevelCategory?>.Accessor LevelCategoryAccessor = FieldAccessor<LevelSelectionFlowCoordinator.State, SelectLevelCategoryViewController.LevelCategory?>.GetAccessor("levelCategory");
