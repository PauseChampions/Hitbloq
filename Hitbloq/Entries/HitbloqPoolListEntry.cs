...
namespace Hitbloq.Entries
{
	internal class HitbloqPoolListEntry
	{
		...
		public static NameComparer NameComparer => _nameComparer ??= new NameComparer();

		private static PlayerCountComparer? _playerCountComparer;
		public static PlayerCountComparer PlayerCountComparer => _playerCountComparer ??= new PlayerCountComparer();

		private static PopularityComparer? _popularityComparer;
		public static PopularityComparer PopularityComparer => _popularityComparer ??= new PopularityComparer();
